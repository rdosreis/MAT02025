...
- Note que $a_ia_j$ é igual a $1$ se as unidades $i$ e $j$ estiverem na amostra, ou é $0$, caso contrário.
    - Logo, $\E(a_ia_j) = 1 \times \Pr(a_ia_j = 1) + 0 \times \Pr(a_ia_j = 0) = \Pr(a_ia_j = 1) = \Pr(a_i = 1, a_j = 1)$.
